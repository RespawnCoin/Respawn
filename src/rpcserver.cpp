...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Respawn server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Respawn features */
        {"respawn", "masternode", &masternode, true, true, false},
        {"respawn", "listmasternodes", &listmasternodes, true, true, false},
        {"respawn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"respawn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"respawn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"respawn", "masternodedebug", &masternodedebug, true, true, false},
        {"respawn", "startmasternode", &startmasternode, true, true, false},
        {"respawn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"respawn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"respawn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"respawn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"respawn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"respawn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"respawn", "mnbudget", &mnbudget, true, true, false},
        {"respawn", "preparebudget", &preparebudget, true, true, false},
        {"respawn", "submitbudget", &submitbudget, true, true, false},
        {"respawn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"respawn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"respawn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"respawn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"respawn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"respawn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"respawn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"respawn", "checkbudgets", &checkbudgets, true, true, false},
        {"respawn", "mnsync", &mnsync, true, true, false},
        {"respawn", "spork", &spork, true, true, false},
        {"respawn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"respawn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use respawnd, or the -server option to respawn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> respawn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5601/\n";
}
