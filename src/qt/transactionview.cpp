                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Rsp from zRsp"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zRsp"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zRsp));
