...
/** Utility functions used by the Respawn Qt UI.
 */
namespace GUIUtil
{
...
// Render Respawn addresses in monospace font
...
// Parse "respawn:" URI into recipient object, return true on successful parsing
