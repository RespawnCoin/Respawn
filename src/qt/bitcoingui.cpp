                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Respawn Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Respawn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and respawn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zRSP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Respawn Core"), this);
    aboutAction->setStatusTip(tr("Show information about Respawn Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Respawn"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Respawn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Respawn addresses"));
    ...
    openAction->setStatusTip(tr("Open a Respawn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Respawn Core help message to get a list with possible Respawn command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Respawn Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Respawn network", "", count));
}
...
{
    QString strTitle = tr("Respawn Core"); // default title
