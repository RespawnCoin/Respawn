...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Respawn Core respawn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  respawn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded respawn transaction") + "\n" +
                               "  respawn-tx [options] -create [commands]   " + _("Create hex-encoded respawn transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded respawn transaction
