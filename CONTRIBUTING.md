Contributing to Respawn Core
============================

The Respawn Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Respawn Core project, and is not to be
confused with overall Respawn Network Protocol consensus changes.

Whether a pull request is merged into Respawn Core rests with the project merge
...
Patches that change Respawn consensus rules are considerably more involved than
...
Where a patch set proposes to change the Respawn consensus, it must have been
...
The project leader is the release manager for each Respawn Core release.
