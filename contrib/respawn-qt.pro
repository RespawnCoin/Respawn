...
RESOURCES += src/qt/respawn.qrc src/qt/respawn_locale.qrc

TRANSLATIONS += src/qt/locale/respawn_bg.ts \
                src/qt/locale/respawn_de.ts \
                src/qt/locale/respawn_en.ts \
                src/qt/locale/respawn_es.ts \
                src/qt/locale/respawn_fi.ts \
                src/qt/locale/respawn_fr.ts \
                src/qt/locale/respawn_it.ts \
                src/qt/locale/respawn_ja.ts \
                src/qt/locale/respawn_pl.ts \
                src/qt/locale/respawn_pt.ts \
                src/qt/locale/respawn_ru.ts \
                src/qt/locale/respawn_sk.ts \
                src/qt/locale/respawn_sv.ts \
                src/qt/locale/respawn_vi.ts \
                src/qt/locale/respawn_zh_CN.ts \
                src/qt/locale/respawn_zh_TW.ts
