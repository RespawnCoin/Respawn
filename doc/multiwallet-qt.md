...
In order to support loading of multiple wallets in respawn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is respawn.cpp.
...
Changes to respawn.cpp
----------------------
respawn.cpp is the entry point into respawn-qt, and as such, will require some minor modifications to provide hooks for
